...
$string['privacy:metadata:coursefullname'] = 'Поўная назва курса, зь якога карыстальнік атрымаў доступ да LTI-Спажывальніка';
$string['privacy:metadata:courseid'] = 'ID курса, зь якога карыстальнік атрымаў доступ да LTI-Спажывальніка';
$string['privacy:metadata:courseidnumber'] = 'ID нумар курса, зь якога карыстальнік атрымаў доступ да LTI-Спажывальніка';
$string['privacy:metadata:courseshortname'] = 'Кароткая назва курса, зь якога карыстальнік атрымаў доступ да LTI-Спажывальніка';
...
$string['publickeyset_help'] = 'Публічны набор ключоў, зь якога гэты сайт будзе атрымліваць публічны ключ сродку дзеля праверкі подпісаў уваходных паведамленьняў і запытаў сэрвісу.';
...
Яго можа выкарыстоўваць дастаўнік сродку дзеля ўнікальнай ідэнтыфікацыі сайта Moodle, зь якога карыстальнік запусьціў сродак.
...
Напрыклад, базавая спасылка *tool.com* будзе адпавядаць наступнаму:
...
Базавая спасылка *www.tool.com/quizzes* будзе адпавядаць наступнаму:

* www.tool.com/quizzes
* tool.com/quizzes
* tool.com/quizzes/take.php?id=10

Базавая спасылка *quiz.tool.com* будзе адпавядаць наступнаму:

* quiz.tool.com
* quiz.tool.com/take.php?id=10

Калі маюцца дзьве розныя канфігурацыі сродку прызначаныя для аднога дамену, будзе выкарыстоўвацца найбольш прыдатны варыянт.

Вы таксама можаце ўстаўляць спасылку картрыджу, калі яна маецца ў вас, і дадзеныя будуць запоўнены аўтаматычна.';
$string['toolurlplaceholder'] = 'Спасылка сродку...';
$string['typename'] = 'Назва сродку';
$string['typename_help'] = 'Назва сродку выкарыстоўваецца дзеля ідэнтыфікацыі дастаўніка сродку ў Moodle. Уведзеная назва будзе бачная настаўнікам падчас даданьня вонкавых сродкаў у курсы.';
$string['types'] = 'Тыпы';
$string['unabletocreatetooltype'] = 'Нельга стварыць сродак';
$string['unabletofindtooltype'] = 'Нельга знайсьці сродак дзеля {$a->id}';
$string['unknownstate'] = 'Невядомы статус';
$string['update'] = 'Абнавіць';
$string['useraccountinformation'] = 'Акаўнцкая інфармацыя карыстальніка';
$string['userpersonalinformation'] = 'Асабістая інфармацыя карыстальніка';
$string['using_tool_cartridge'] = 'Выкарыстаны картрыдж сродку';
$string['using_tool_configuration'] = 'Выкарыстаная канфігурацыя сродку:';
$string['validurl'] = 'Слушная спасылка мусіць пачынацца з http(s)://';
$string['viewsubmissions'] = 'Праглядзець экран адпраўленьняў і ацэньваньня';
