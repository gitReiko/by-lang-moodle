...
/**
 * Strings for component 'files', language 'en', version '4.0'.
 *
 * @package     files
 * @category    string
...
$string['privacy:metadata:files:timemodified'] = 'Час апошняй зьмены файла';
$string['privacy:metadata:files:userid'] = 'Карыстальнік, які стварыў файл';
