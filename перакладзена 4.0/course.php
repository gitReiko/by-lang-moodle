...
$string['aria:defaulttab'] = 'Актыўнасьці па змоўчанньні';
...
$string['completion_manual:aria:done'] = '{$a} адзначаны як выкананы. Націсьніце, каб скасаваць.';
...
$string['customfield_islocked_help'] = 'Калі поле заблакавана, толькі карыстальнікі са здольнасьцю зьмены заблакаваных карыстальніцкіх палёў (па змаўчаньні карыстальнікі з рольлю кіроўны (якая наладжана па змаўчаньні) змогуць зьмяніць яго ў наладах курса.';
$string['customfield_notvisible'] = 'Аніхто';
$string['customfield_visibility'] = 'Бачны для';
$string['customfield_visibility_help'] = 'Гэта налада вызначае, хто можа праглядаць назву і значэньне карыстальніцкага поля ў сьпісе курсаў ці ў фільтры даступных карыстальніцкіх палёў у Адукаваньні.';
...
$string['downloadcoursecontent_help'] = 'Гэтая налада вызначае, ці могуць спампоўваць зьмесьціва курса карыстальнікі са здольнасьцю спампоўкі зьмесьціва курса (па змаўчаньні - гэта карыстальнікі з рольлю студэнт ці настаўнік).';
...
$string['target:norecentaccesses_help'] = 'Гэтая мэта вызначае студэнтаў, якія не ўваходзілі ў курс, у які яны залічаны, цягам усталяванага інтэрвалу аналізу (па змаўчаньні, за апошні месяц).';
$string['target:norecentaccessesinfo'] = 'Наступныя студэнты не ўваходзілі ў курс, у які яны залічаны, цягам усталяванага інтэрвалу аналізу (па змаўчаньні, за апошні месяц).';
