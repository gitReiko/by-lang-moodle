...
$string['ivs_setting_match_question_help'] = 'In-video questions: Use single-choice and open questions to test learners’ prior knowledge and understanding directly in the video. When the question appears, the video stops; learners cannot continue until the question is answered (correctly).';
