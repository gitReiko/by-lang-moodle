...
$string['accessdenied'] = 'Доступ забаронены';
$string['accounts'] = 'Акаўнты';
$string['addcategory'] = 'Дадаць катэгорыю';
$string['additionalhtml'] = 'Дадатковы HTML';
$string['additionalhtml_desc'] = 'Гэтая налада дазваляе вам вызначаць HTML, які вы жадаеце дадаць на кожную старонку. Вы можаце вызначыць HTML, які будзе даданы ў тэг HEAD старонкі, адразу пасьля адкрыцьця тэгу BODY, альбо непасрэдна перад закрыцьцём тэгу body.<br />Тое дазволіць вам дадаваць уласныя загалоўкі і споды на кожную старонку, альбо дадаць падтрымку сэрвісаў кшалту Google Аналітыка, вельмі проста, незалежна ад абранай тэмы.';
$string['additionalhtml_heading'] = 'Дадатковы HTML, які будзе даданы на кожную старонку.';
$string['additionalhtmlfooter'] = 'Перад закрыцьцём BODY';
$string['additionalhtmlfooter_desc'] = 'Тутэйшае зьмесьціва будзе дадана на кожную старонку непасрэдна перад закрыцьцём тэгу body.';
$string['additionalhtmlhead'] = 'Унутры HEAD';
$string['additionalhtmlhead_desc'] = 'Тутэйшае зьмесьціва будзе дадана на кожную старонку ўніз тэга HEAD.';
$string['additionalhtmltopofbody'] = 'Пасьля адкрыцьця BODY';
$string['additionalhtmltopofbody_desc'] = 'Тутэйшае зьмесьціва будзе дадана на кожную старонку адразу пасьля адкрыцьця тэгу body.';
$string['admincategory'] = 'Катэгорыя: {$a}';
$string['adminseesall'] = 'Адміны бачаць усё';
$string['adminseesallevents'] = 'Адміністратары бачаць усе падзеі';
$string['adminseesownevents'] = 'Адміністратары - такія ж карыстальнікі, як і іншыя';
$string['advancedfeatures'] = 'Прасунутыя функцыі';
$string['agedigitalconsentverification'] = 'Праверка лічбавага ўзросту згоды';
$string['agedigitalconsentverification_desc'] = 'Уключае праверку лічбавага ўзросту згоды перад адлюстраваньнеі старонкі ўваходу дзеля карыстальнікаў, што рэгіструюцца самастойна. Тое бароніць вашы сайт ад непаўнагадовых, што рэгіструюцца бяз згоды бацькоў ці апекуноў. <a target="_blank" href="{$a}">Кантактная інфармацыя</a> для непаўнагадовых дзеля далейшай патрымкі.';
$string['ageofdigitalconsentmap'] = 'Лічбавы ўзрост згоды';
$string['ageofdigitalconsentmap_desc'] = 'Тут льга вызначыць стандартны лічбавы ўзрост згоды ды ўзрост дзеля ўсякай краіны, дзе ён адрозьніваецца ад стандартнага. Увядзіце кожны ўзрост з новага радка ў фармаце: код краіны, узрост (праз коску). Стандартны ўзрост вызначаецца * заміж коду краіны. Коды краін вызначаюцца па стандарце ISO 3166-2.';
$string['allcountrycodes'] = 'Усе коды краін';
$string['allowattachments'] = 'Дазволіць укладаньні';
$string['allowbeforeblock'] = 'Дазволены сьпіс будзе апрацаваны першым';
$string['allowbeforeblockdesc'] = 'Па стандарце запісы са сьпісу заблакаваных IP-адрасоў апрацоўваюцца першымі. Калі ўключана гэтая опцыя, запісы са сьпісу дазволеных IP-адрасоў будуць апрацоўвацца раней за заблакаваныя.';
$string['allowcategorythemes'] = 'Дазволіць тэмы для катэгорыяў';
$string['allowcohortthemes'] = 'Дазволіць тэмы для кагортаў';
$string['allowcoursethemes'] = 'Дазволіць тэмы для курсаў';
$string['allowedemaildomains'] = 'Дазволеныя дамены імэйлаў';
$string['allowediplist'] = 'Сьпіс дазволеных IP-адрасоў';
$string['allowemailaddresses'] = 'Дазволеныя дамены імэйлаў';
$string['allowemojipicker'] = 'Выбарнік эмодзі';
$string['allowframembedding'] = 'Дазволіць убудову фрэйма';
$string['allowframembedding_help'] = 'Калі ўключана, гэты сайт будзе льга ўбудоўваць у фрэйм у вонкавай сістэме, як рэкамендуецца падчас выкарыстаньня плагіна залічэньня \'Публікаваць як LTI сродак\'. Калі вам тое ня трэба, рэкамендуецца пакінуць убудову фрэйму адключанай у мэтах бясьпекі. Зьвярніце ўвагу, дзеля мабільнага дадатка гэтая налада ігнаруецца і ўбудова фрэйма заўжды дазволена.';
$string['allowguestmymoodle'] = 'Дазволіць гасьцявы доступ да Прыладавай';
$string['allowindexing'] = 'Дазволіць індэксацыю пошукавым сістэмам';
$string['allowindexing_desc'] = 'Вызначае, ці дазволена пошукавым сістэмам індэксаваць (шукаць) вашы сайт. "Усюды" дазволіць пошукавым сістэмам шукаць усюды, у тым ліку на старонках уваходу, то бок сайты з уключанай функцыяй Прымусовы Ўваход усё адно будуць індэксавацца. Каб пазьбегнуць рызыкі спаму, зьвязанай з магчымасьцю пошука на старонцы ўваходу, выкарыстоўвайце "Усюды апрача старонак уваходу". "Нідзе" забараняе пошукавым сістэмам індэксаваць усе старонкі. Зьвярніце ўвагу, гэта толькі тэг у загалоўке сайта. Ад пошукавай сістэмы залежыць, ці будзе яна прытрымлівацца гэтага тэгу.';
$string['allowindexingeverywhere'] = 'Усюды';
$string['allowindexingexceptlogin'] = 'Усюды апрача старонак уваходу';
$string['allowindexingnowhere'] = 'Нідзе';
$string['allowobjectembed'] = 'Дазволіць тэгі EMBED і OBJECT';
$string['allowthemechangeonurl'] = 'Дазволіць зьмену тэмы праз спасылку';
$string['allowuserblockhiding'] = 'Дазволіць карыстальнікам хаваць блокі';
$string['allowusermailcharset'] = 'Дазволіць карыстальніку абіраць набор знакаў';
$string['allowuserswitchrolestheycantassign'] = 'Дазволіць карыстальнікам бяз здольнасьці прызначэньня роляў пераключаць ролі';
$string['allowuserthemes'] = 'Дазволіць тэмы для карыстальнікаў';
$string['alternativefullnameformat'] = 'Альтэрнатыўны фармат поўнага імя';
$string['alternativefullnameformat_desc'] = 'Вызначае, як імёны будуць адлюстроўвацца для карыстальнікаў са здольнасьцю viewfullnames (па стандарту - карыстальнікі з рольлю кіраўнік, настаўнік і настаўнік-нерэдактар). Запаўняльнікі, якія льга выкарыстоўваць дзеля налады "Фармат поўнага імя".';
$string['always'] = 'Заўжды';
$string['appearance'] = 'Выгляд';
$string['aspellpath'] = 'Шлях да aspell';
$string['authentication'] = 'Аўтэнтыфікацыя';
$string['authpreventaccountcreation'] = 'Пазьбягаць стварэньня акаўнтаў падчас аўтэнтыфікацыі';
$string['authpreventaccountcreation_help'] = 'Падчас аўтэнтыфікацыі карыстальніка аўтаматычна ствараецца акаўнт на сайце, калі ён дагэтуль не існуе. Калі дзеля аўтэнтыфікацыі выкарыстоўваецца вонкавая база дадзеных, напрыклад LDAP, але вы жадаеце абмежаваць доступ да сайту толькі для карыстальнікаў зь існым акаўнтам, то гэтую наладу варта ўключыць. Новыя акаўнты прыйдзецца ствараць уручную альбо праз функцыю запампоўкі карыстальнікаў. Зьвярніце ўвагу, гэтая налада не ўжываецца да MNet-аўтэнтыфікацыі.';
$string['authsettings'] = 'Кіраваць аўтэнтыфікацыяй';
$string['autolang'] = 'Аўтавызначэньне мовы';
$string['autolangusercreation'] = 'Падчас стварэньня акаўнта ўсталяваць мову браўзара карыстальніка ў якасьці пераважнай мовы';
$string['autologinguests'] = 'Аўтаўваход гасьцей';
$string['availablelicenses'] = 'Даступныя ліцэнзіі';
$string['availableto'] = 'Даступна да';
$string['backgroundcolour'] = 'Празрысты колер';
$string['backup_shortname'] = 'Выкарыстоўваць назву курса ў назве файлу рэзервовай копіі';
$string['backup_shortnamehelp'] = 'Выкарыстоўваць назву курса як частку назвы файлу рэзервовай копіі.';
$string['backups'] = 'Рэзервовыя копіі';
$string['badwordsconfig'] = 'Увядзіце сьпіс дрэнных словаў, падзяліўшы іх коскамі.';
$string['badwordsdefault'] = 'Калі наладжвальны сьпіс пусты, будзе выкарыстаны стандартны сьпіс з моўнага пакету.';
$string['badwordslist'] = 'Сьпіс наладжвальных дрэнных словаў';
$string['blockediplist'] = 'Сьпіс Заблакаваных IP';
$string['blockinstances'] = 'Экзэмпляры';
$string['blockmultiple'] = 'Мноства';
$string['blockprotect'] = 'Бараніць экзэмпляры';
$string['blockprotect_help'] = 'Калі вы заблакуеце пэўны тып блокаў, то аніхто ня зможа дадаваць ды выдаляць яго экзэмпляры (Вядома, вы зможаце разблакаваць яго пазьней, калі вам спатрэбіцца рэдагаваньне экзэмпляраў).

Гэта зроблена дзеля абароны гэткіх блокаў, як навігацыя і налады, якія вельмі складана аднавіць пасьля выпадковага выдаленьня.';
$string['blocksettings'] = 'Кіраваць блокамі';
$string['blockunprotect'] = 'Зьняць абарону';
$string['bloglevel'] = 'Бачнасьць блогу';
$string['bookmarkadded'] = 'Закладка дадана.';
$string['bookmarkalreadyexists'] = 'Вы ўжо дадалі гэтую старонку ў закладкі.';
$string['bookmarkdeleted'] = 'Закладка выдалена.';
$string['bookmarkthispage'] = 'Дадаць у закладкі гэтую старонку';
$string['cacheapplication'] = 'Кэш дадатку';
$string['cacheapplicationhelp'] = 'Кэшаваныя прадметы даступныя ўсім карыстальнікам і пратэрміноўваюцца праз пэўны час жыцьця (ttl).';
$string['cachejs'] = 'Кэшаваць Javascript';
$string['cachejs_help'] = 'Кэшаваньне і сьцісканьне Javascript значна паляпшае загрузку старонак. Настойліва рэкамендуецца дзеля вытворчых сайтаў. Распрацоўнікі, верагодна, жадаюць адключыць гэтую функцыю.';
$string['cacherequest'] = 'Кэш запытаў';
$string['cacherequesthelp'] = 'Карыстальніцкі кэш, які пратэрміноўваецца пасьля выкананьня запыту. Створаны дзеля замены вобласьцяў, дзе мы выкарыстоўваем статычныя сховішчы.';
$string['cachesession'] = 'Кэш сэсіяў';
$string['cachesessionhelp'] = 'Карыстальніцкі кэш, які пратэрміноўваецца пасьля завяршэньня сэсіі карыстальніка. Неабходны для зьмяншэньня разьдзіманьня/нагрузкі сэсіяў.';
$string['cachesettings'] = 'Налады кэшу';
$string['cachetemplates'] = 'Шаблоны кэшу';
$string['cachetemplates_help'] = 'Кэшаваньне шаблонаў павышае прадукцыйнасьць загрузкі старонак і настойліва рэкамендуецца дзеля вытворчых сайтаў. Распрацоўнікі, верагодна, жадаюць адключыць гэтую функцыю.';
$string['caching'] = 'Кэшаваньне';
$string['calendar_weekend'] = 'Выходныя дні';
$string['calendarexportsalt'] = 'Соль для экспарту каляндару';
$string['calendarsettings'] = 'Каляндар';
$string['calendartype'] = 'Тып каляндару';
$string['calendartype_desc'] = 'Абярыце стандартны тып каляндару дзеля ўсёга сайту. Гэтую наладу льга перавызначыць у наладах курса альбо яе могуць зьмяніць карыстальнікі ў сваіх асабістых профілях.';
$string['cannotdeletemodfilter'] = 'Вы ня можаце выдаліць \'{$a->filter}\', бо ён з\'яўляецца часткай модуля \'{$a->module}\'.';
$string['cannotuninstall'] = '{$a} ня можа быць выдалены.';
$string['categoryemail'] = 'Імэйл';
$string['cfgwwwrootslashwarning'] = '$CFG->wwwroot вызначаны хібна ў файле config.php . Ён утрымлівае ў канцы знак \'/\', яго неабходна выдаліць.';
$string['cfgwwwrootwarning'] = '$CFG->wwwroot вызначаны хібна ў файле config.php . Ён мусіць супадаць са спасылкай, якую вы выкарыстоўваеце дзеля ўваходу на гэтую старонку.';
$string['change'] = 'зьмяніць';
$string['checkboxno'] = 'Не';
$string['checkboxyes'] = 'Так';
$string['checkupgradepending'] = 'Абнавіць';
$string['choosefiletoedit'] = 'Абярыце файл для рэдагаваньня';
$string['cleanup'] = 'Ачыстка';
$string['clianswerno'] = 'n';
$string['cliansweryes'] = 'y';
$string['cliexitgraceful'] = 'Вытанчаны выхад, калі ласка, пачакайце...';
$string['cliexitnow'] = 'Выхад наўпрост ЗАРАЗ';
...
$string['clistatusdisabled'] = 'Статус: адключана';
$string['clistatusenabled'] = 'Статус: уключана';
$string['clistatusenabledlater'] = 'статус: рэжым абслугоўваньня CLI будзе ўключаны {$a}';
...
$string['cliupgradedefault'] = 'Новая налада: {$a}';
$string['cliupgradedefaultheading'] = 'Усталёўка новых стандартных значэньняў';
$string['cliupgradedefaultverbose'] = 'Новая налада: {$a->name}, Стандартнае значэньне: {$a->defaultsetting}';
$string['cliupgradefinished'] = 'Абнаўленьне каманднага радка з версіі {$a->oldversion} да {$a->newversion} пасьпяхова выканана.';
$string['cliupgradenoneed'] = 'Абнаўленьне ўсталёванай версіі {$a} не патрабуецца. У кожным разе, дзякуй, што прыйшлі!';
$string['cliupgradepending'] = 'Чакаецца абнаўленьне';
$string['cliyesnoprompt'] = 'надрукуйце y (yes) ці n (n=no)';
$string['close'] = 'Закрыць';
$string['commentsperpage'] = 'Паказваць каментароў на старонцы';
$string['commonactivitysettings'] = 'Агульныя налады актыўнасьці';
$string['commonfiltersettings'] = 'Агульныя налады фільтраў';
$string['commonsettings'] = 'Агульныя налады';
$string['componentinstalled'] = 'Усталяваны кампанент';
$string['computedfromlogs'] = 'Разьлічана з логаў ад {$a}.';
$string['condifmodeditdefaults'] = 'Стандартныя значэньні выкарыстоўваюцца ў форме наладаў падчас стварэньня новай актыўнасьці ці рэсурса.';
$string['confeditorhidebuttons'] = 'Абярыце кнопкі, якія трэба схаваць у HTML-рэдактары.';
$string['configallcountrycodes'] = 'Гэта сьпіс краін, якія льга абраць у розных месцах, напрыклад, у профіле карыстальніка. Калі ён пусты (па-стандарту), выкарыстоўваецца сьпіс з файлу countries.php стандартнага англійскага моўнага пакету. Гэта сьпіс са стандарту ISO 3166-1. У адваротным выпадку вы можаце вызначыць сьпіс кадоў, падзеленых коскамі, напрыклад, \'GB,FR,ES\'. Дзеля даданьня сюды новых нестандартных кодаў вам спачатку трэба дадаць коды ў countries.php ў тэчку \'en\' і вашы моўны пакет.';
$string['configallowassign'] = 'Дзеля кожнай ролі ў левым слупку абярыце ролі, якія яны могуць прызначаць іншым.';
$string['configallowattachments'] = 'Калі ўключана, імэйлы адпраўленыя з сайту, могуць утрымліваць укладаньні, напрыклад дасягненьні.';
$string['configallowcategorythemes'] = 'Калі вы ўключыце гэтае, то тэмы будзе льга ўсталёўваць на ўзроўне катэгорыі. Гэта будзе ўплываць на ўсе даччыныя катэгорыі і курсы, калі толькі яны адмыслова не ўсталявалі сваю ўласную тэму. УВАГА: Уключэньне тэмаў дзеля катэгорыяў можа паўплываць на прадукцыйнасьць.';
$string['configallowcohortthemes'] = 'Калі вы ўключыце гэтае, то тэмы будзе льга ўсталёўваць на ўзроўне кагортаў. Гэта паўплывае на ўсіх карыстальнікаў з адной ці некалькімі кагортамі, але з адной і той жа тэмай.';
$string['configallowcoursethemes'] = 'Калі ўключана, курсам будзе дазволена ўсталёўваць свае ўласныя тэмы. Тэмы курсаў скасоўваюць усе іншыя варыянты тэмаў (сайту, карыстальнікаў, катэгорыяў, кагортаў ці тэмы вызначаныя спасылкай).';
$string['configallowedemaildomains'] = 'Сьпіс даменаў імэйлаў, якія льга раскрываць у падзеле "Ад" імэйлаў, што адпраўляюцца сайтам. Стандартнае "Пустое" будзе выкарыстоўваць адрас No-reply (без адказу) дзеля ўсіх імэйлаў, што адпраўляюцца. Дазваляецца выкарыстоўваць запаўняльнікі, кшалту, *.example.com які дазволіць адпраўляць усе лісты з усякага паддамена example.com, але не з самога example.com. Тое запатрабуе асобнага запісу.';
$string['configallowemailaddresses'] = 'Дзеля абмежаваньня новых імэйлаў пэўнымі даменамі, вызначце іх тут праз прабел. Усе іншыя дамены будуць забаронены. Дзеля дазваленьня паддаменаў дадайце да дамену прэфікс \'.\'. Дзеля дазваленьня каранёвага дамену, зь яго паддаменамі, дадайце дамен двойчы - адзін раз з прэфіксам \'.\' і адзін раз без яго, напрыклад, .ourcollege.edu.au ourcollege.edu.au.';
$string['configallowemojipicker'] = 'Функцыя абраньня эмодзі дазваляе карыстальнікам абіраць смайлікі, якія будуць будуць даданы ў паведамленьні і іншыя тэкставыя вобласьці праз кнопку абраньня эмодзі на панэлі прыладаў Atto (тэкт. рэд).';
$string['configallowemojipickerincompatible'] = 'Вашая цяперашняя канфігурацыя базы дадзеных не падтрымлівае эмодзі належным чынам. Дзеля ўключэньня абіральніка эмодзі, вам трэба <a href="https://docs.moodle.org/en/MySQL_full_unicode_support">абнавіць вашую базу дадзеных да поўнай падтрымкі юнікода</a>.';
$string['configallowguestmymoodle'] = 'Калі ўключана, госьці будуць мець доступ да Прыладавай. У адваротным выпадку госьці будуць перанакіроўваюцца ў дом сайта.';
$string['configallowobjectembed'] = 'У якасьці стандартнай меры бясьпекі звычайным карыстальнікам забараняецца ўбудоўваць мультымедыя (кшалту Flash) у тэксты непасрэдна праз тэгі EMBED і OBJECT у HTML (але памятайце, маецца шлях бясьпечнай убудовы гэткага зьмесьціва праз мультымедыя фільтар). Калі вы жадаеце дазволіць выкарыстаньне тэгаў EMBED і OBJECT, уключыце гэтую наладу.';
...
$string['fullnamedisplay'] = 'Фармат поўнага імя';
$string['fullnamedisplayprivate'] = 'Фармат поўнага імя - прыватны';
...
$string['h5pgetcontenttypestask'] = 'Спампоўваць даступныя тыпы кантэнту H5P з h5p.org';
