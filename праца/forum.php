...
$string['duedate_help'] = 'This is when posting in the forum is due. Although this date is displayed in the calendar as the Да даты for the forum, posting will still be allowed after this date. Set a forum Дата сканчэньня to prevent posting to the forum after a certain date.';
$string['duedatetodisplayincalendar'] = 'Да даты to display in calendar';
...
$string['forum:canoverridecutoff'] = 'Post to forums after their Дата сканчэньня';
