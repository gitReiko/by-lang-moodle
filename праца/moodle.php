...
$string['coursereasonforrejectingemail'] = 'Гэта будзе адпраўлена на email заяўніку';
...
$string['currentcourseadding'] = 'Абраны курс, даданне дадзеных да яго';
$string['currentcoursedeleting'] = 'Абраны курс, папярэдняе выдаленне';
