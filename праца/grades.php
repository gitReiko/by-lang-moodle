...
$string['displaylettergrade'] = 'Адлюстроўваць адзнакі-літары';
...
$string['editgradeletters'] = 'Рэдагаваць літары адзнак';
...
$string['errorupdatinggradecategoryaggregation'] = 'Памылка абнаўленьня тыпу агрэгацыі катэгорыі адзнак з ID {$a->id}';
...
$string['eventgradelettercreated'] = 'Літара адзнакі створана';
$string['eventgradeletterdeleted'] = 'Літара адзнакі выдалена';
$string['eventgradeletterupdated'] = 'Літара адзнакі абноўлена';
...
$string['gradeboundary'] = 'Мяжа адзнакі-літары';
$string['gradeboundary_help'] = 'Гэтая налада вызначае мінімальны адсотак, пасьля перавышэньня якога адзнакі будзе прысвоена адзнака-літара.';
...
$string['gradeexportdisplaytype_desc'] = 'Адзнакі льга паказваць падчас экспарту ў натуральным выглядзе, у адсотках (датычна да мінімальнай і максімальнай адзнакі) ці ў выглядзе літараў (A, B, C і г.д.). Гэтае льга перавызначыць падчас экспарту.';
