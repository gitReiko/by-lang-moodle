...
$string['allow'] = 'Уключыць';
$string['allowsetting'] = 'Дазволіць сродку захоўваць 8K наладаў у Moodle';
$string['always'] = 'Заўжды';
$string['autoaddtype'] = 'Дадаць сродак';
$string['automatic'] = 'Аўтаматычна, на грунце спасылкі сродку';
$string['baseurl'] = 'Рэгістрацыйная назва базай спасылкі/сродку';
$string['basiclti'] = 'LTI';
$string['basiclti_base_string'] = 'Базавы радок LTI OAuth';
$string['basiclti_endpoint'] = 'Канчатковая кропка запуску LTI';
$string['basiclti_in_new_window'] = 'Вашая актыўнасьць адкрыта ў новым акне';
$string['basiclti_in_new_window_open'] = 'Адкрыць у новым акне';
$string['basiclti_parameters'] = 'Параметры запуску LTI';
$string['basicltiactivities'] = 'LTI актыўнасьці';
$string['basicltifieldset'] = 'Прыклад уласнага набору палёў';
$string['basicltiintro'] = 'Апісаньне актыўнасьці';
$string['basicltiname'] = 'Назва актыўнасьці';
$string['basicltisettings'] = 'Базавыя налады Learning Tool Interoperability (LTI)';
$string['cachedef_keyset'] = 'Кэш інфармацыі пра набор клавіш сродку';
$string['cancel'] = 'Скасаваць';
$string['cancelled'] = 'Скасавана';
$string['cannot_delete'] = 'Вы ня можаце выдаліць гэтую канфігурацыю сродку.';
$string['cannot_edit'] = 'Вы ня можаце рэдагаваць гэтую канфігурацыю сродку.';
$string['capabilities'] = 'Здольнасьць';
$string['capabilities_help'] = 'Абярыце тыя здольнасьці, якія жадаеце прапанаваць дастаўніку сродку. Вы здольныя абраць некалькі здольнасьцяў.';
$string['capabilitiesrequired'] = 'Дзеля актывацыі гэты сродак патрабуе доступ да наступных дадзеных:';
$string['cleanaccesstokens'] = 'Выдаленьне пратэрмінаваных токенаў доступу вонкавага сродку';
$string['click_to_continue'] = '<a href="{$a->link}" target="_top">Націсьніце, каб працягнуць</a>';
$string['clientidadmin'] = 'ID кліента';
$string['clientidadmin_help'] = 'ID кліента - гэта ўнікальнае значэньне, якое выкарыстоўваецца дзеля ідэнтыфікацыі сродку. Ён ствараецца аўтаматычна дзеля конжнага сродку, які выкарыстоўвае профіль бясьпекі JWT, уведзены ў LTI 1.3, і мусіць быць часткай дадзеных, што перадаюцца дастаўніку сродку, каб ён мог сканфігураваць злучэньне на сваім канцы.';
$string['comment'] = 'Каментар';
$string['configpassword'] = 'Стандартны пароль вонкавага сродку';
$string['configpreferheight'] = 'Стандартная пераважная вышыня';
$string['configpreferwidget'] = 'Усталяваць віджэт стандартным запускальнікам';
$string['configpreferwidth'] = 'Стандартная пераважная шырыня';
...
$string['contentitem_deeplinking_help'] = 'Калі ўключана, опцыя \'Абраць зьмесьціва\' будзе даступнай падчас даданьня вонкавага сродку.';
$string['contentitem_help'] = 'Калі ўключана, опцыя \'Абраць зьмесьціва\' будзе даступнай падчас даданьня вонкавага сродку.';
$string['contentitem_multiple_description'] = 'Наступныя прадметы будуць даданыя ў вашы курс:';
$string['contentitem_multiple_graded'] = 'Актыўнасьць ацэньваецца (Максімальная адзнака: {$a})';
$string['course_tool_types'] = 'Сродкі курса';
$string['courseactivitiesorresources'] = 'Актыўнасьці і рэсурсы курса';
$string['courseid'] = 'ID нумар курса';
$string['courseinformation'] = 'Інфармацыя курса';
$string['courselink'] = 'Перайсьці да курса';
$string['coursemisconf'] = 'Курс хібна сканфігураваны';
$string['createdon'] = 'Створана на';
$string['curllibrarymissing'] = 'Дзеля Вонкавага сродку патрабуецца пашырэньне PHP cURL.';
$string['custom'] = 'Уласныя параметры';
$string['custom_config'] = 'Выкарыстоўваць уласную канфігурацыю сродку.';
$string['custom_help'] = 'Уласныя параметры - гэта налады, што выкарыстоўваюцца дастаўнікам сродку.
Напрыклад, уласныя параметры могуць выкарыстоўвацца дзеля адлюстраваньня пэўнага рэсурсу ад дастаўніка.
Кожны параметр мусіць быць уведзены ў асобны радок ў фармаце "назва=значэньне", напрыклад, "chapter=3" ці "глава=3".

Гэтае поле льга бясьпечна пакінуць бяз зьменаў, калі няма прамых указаньняў ад дастаўніка сродку.';
$string['custominstr'] = 'Уласныя параметры';
$string['debuglaunch'] = 'Опцыя адладжваньня';
...
$string['password_help'] = 'Дзеля загадзя сканфігураваных сродкаў не трэба ўводзіць агульны сакрэт у гэтае поле, бо агульны сакрэт будзе брацца з канфігурацыі.

Гэтае поле варта запоўніць, калі ствараецца спасылка на дастаўнік сродку, што ня мае канфігурацыі.
Калі дастаўнік сродку выкарыстоўваецца больш за адзін раз у гэтым курсе, даданьне курсавой канфігурацыі сродку з\'яўляецца добрай ідэяй.
